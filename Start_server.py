...
def start_server(port):
    ...
    #                shell=True)
    server_process = subprocess.Popen(['C:/Users/ITWM/Desktop/WindowsNoEditor/CarlaUE4.exe', '-carla-port=' + str(port),'-dx12','-carla-server', '-quality-level=Low', "-RenderOffScreen"])
